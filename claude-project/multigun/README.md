# USPSA Multigun Rules — Knowledge Base

This folder is the complete **USPSA Multigun Rules** (2026 edition), split into
...
## Notes
- **Scope:** this is the handgun/MULTIGUN book only. It does **not**
