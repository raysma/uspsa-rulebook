# USPSA Competition Rules — Knowledge Base

This folder is the complete **USPSA Competition Rules** (2026 edition), split into
...
## Notes
- **Scope:** this is the handgun/USPSA book only. It does **not**
